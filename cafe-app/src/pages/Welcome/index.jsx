                ...
                <div className={styles.headingContainer}>
                    <div className={styles.headingText}>
                        ...
                        <div className={styles.headingTextContainer}>
                            ...
                            <Typography.MobileHeading2 text={`A full stack developer & designer who brews websites that are as delightful and refreshing as bubble tea`} color={COLOURS.darkGreen} />
